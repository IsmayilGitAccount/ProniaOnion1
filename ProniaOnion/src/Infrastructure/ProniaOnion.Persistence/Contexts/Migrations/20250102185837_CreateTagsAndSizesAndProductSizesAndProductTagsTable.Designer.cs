...
namespace ProniaOnion.Persistence.Contexts.Migrations
{
    ...
    [Migration("20250102185837_CreateTagsAndSizesAndProductSizesAndProductTagsTable")]
    partial class CreateTagsAndSizesAndProductSizesAndProductTagsTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProniaOnion.Domain.Entities.ProductTag", b =>
                {
                    ...
                    b.HasOne("ProniaOnion.Domain.Entities.Tag", null)
                        .WithMany("ProductTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
